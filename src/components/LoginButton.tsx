...
const LoginButton = (props: any) => {
    ...
    return (
        <Link href='/login' passHref>
            <div style={{width: 386, height: 68, backgroundColor: props.backgroundColor, position: 'absolute', left: props.left, right: props.right, top: props.top, bottom: props.bottom, borderRadius: 49, textAlign: 'center'}}>
