        ...
        <div style={{ width: '100%', height: '100vh', overflow: 'hidden' }}>
            ...
            <div style={{ width: '100%', height: '100%', display: 'inline-flex' }}>
                ...
                <div style={{ width: '60%', height: '100%' }}>
                    ...
                    <div style={{ width: 'auto', height: '55%', border: 1, borderStyle: 'solid', borderColor: '#707070' }}>
                        <div style={{ display: 'table', width: '100%', height: '100%' }}>
                            <div style={{ display: 'table-row' }}>
                                <div style={{ display: 'table-cell', width: '33%', height: '25%', textAlign: 'center', fontSize: 20, paddingTop: 30, border: 1, borderStyle: 'solid', borderColor: '#707070' }} onClick={() => {
                                    InputNumber('1');
                                }}>
                                    <h1>1</h1>
                                </div>
