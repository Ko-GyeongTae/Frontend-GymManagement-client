        ...
        <div style={{ width: '100%', height: '100vh' }}>
            ...
            <div style={{ width: '100%', height: '85%', display: 'flex' }}>
                ...
                <div style={{ width: '60%', border: -1, borderStyle: 'solid', borderColor: 'black' }}>
                    <div style={{ width: '100%', height: '38%', textAlign: 'center', border: 1, borderStyle: 'solid', borderColor: 'black' }}>
                        <p style={{ fontSize: 60 }}>{phoneNum.slice(0, 3) + (phoneNum.length > 3 ? '-' : "") + phoneNum.slice(3,7) + (phoneNum.length > 7 ? '-' : "") + phoneNum.slice(7, 11)}</p>
                    </div>
                    <div style={{ width: 'auto', height: '62%', border: 1, borderStyle: 'solid', borderColor: 'black' }}>
                        <div style={{ display: 'table', width: '100%', height: '100%' }}>
                            <div style={{ display: 'table-row' }}>
                                <div style={{ display: 'table-cell', width: '33%', height: '25%', textAlign: 'center', fontSize: 20, paddingTop: 30, border: 1, borderStyle: 'solid', borderColor: 'black' }} onClick={() => {
                                    InputNumber('1');
                                }}>
                                    <h1>1</h1>
                                </div>
