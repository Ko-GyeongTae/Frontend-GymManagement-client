    ...
    return (
        <div style={{ width: '100%', height: '100vh', overflow: 'hidden' }}>
            ...
            <div style={{ width: '100%', height: '100%', display: 'inline-flex' }}>
                <div style={{ width: '40%', height: '85%', backgroundColor: '#8C837A', alignItems: 'center' }}>
                ...
                <div style={{ width: '60%', height: '100%' }}>
                    ...
                    <div style={{ width: 'auto', height: '70%', border: 1, borderStyle: 'solid', borderColor: '#707070', position: 'relative' }}>
                        <div style={{ display: 'table', width: '100%', height: '80%' }}>
                            <div style={{ display: 'table-row' }}>
                                <div style={{ display: 'table-cell', width: '33%', height: '25%', textAlign: 'center', fontSize: 20, paddingTop: 20, border: 1, borderStyle: 'solid', borderColor: '#707070' }} onClick={() => {
                                    InputNumber('1');
                                }}>
                                    <h1>1</h1>
                                </div>
